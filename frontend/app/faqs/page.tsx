...
export default function FAQs() {
  ...
  return (
      ...
      <div className="items-center gap-12 w-full max-w-5xl h-[90vh] border-4 border-black bg-[#E8F4F8] rounded-lg flex flex-col">
        <div className="w-full flex justify-between items-center p-6">
          <div className="w-full flex justify-start">
           ...
           <h1 className= "flex flex-col items-center gap-6 text-lg font-bold">Frequently Asked Questions</h1>
        {faqs.map((faq, index) => (
            <div key={index} className="faq-item p-6 flex flex-col items-center justify-center gap-6 w-200 h-12 rounded-full border-2 border-black bg-white
